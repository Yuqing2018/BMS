...
namespace BackEndMS
{
    ...
    sealed partial class App : Application
    {
        ...
        private static string baseUrl = "https://bms.mmais.com.cn/api/v1/";//"http://10.169.8.208:2330/bms/api/v1/";//
        /// <summary>
        ...
        public static string RootBaseUri
        {
            get
            {
                return baseUrl;
        ...
        public static string RootUserName {
            get {
                if (ApplicationData.Current.LocalSettings.Values.ContainsKey(SavedUserName))
                    return ApplicationData.Current.LocalSettings.Values[SavedUserName].ToString();
                else return "";
            } set {
        ...
        public static string RootPassword {
            get
            {
                if (ApplicationData.Current.LocalSettings.Values.ContainsKey(SavedPassword))
                    return ApplicationData.Current.LocalSettings.Values[SavedPassword].ToString();
                else return "";
            }
            set
            {
